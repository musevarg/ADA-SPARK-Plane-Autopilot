...
package body ada_main is
   ...
   E130 : Short_Integer; pragma Import (Ada, E130, "plane_doors_E");
   E140 : Short_Integer; pragma Import (Ada, E140, "plane_engines_E");
   E144 : Short_Integer; pragma Import (Ada, E144, "warning_lights_E");
   E115 : Short_Integer; pragma Import (Ada, E115, "plane_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "plane__finalize_spec");
      begin
         F1;
      end;
      E144 := E144 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "warning_lights__finalize_spec");
      begin
         F2;
      end;
      E140 := E140 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "plane_engines__finalize_spec");
      begin
         F3;
      end;
      E130 := E130 - 1;
      declare
         procedure F4;
         pragma Import (Ada, F4, "plane_doors__finalize_spec");
      begin
         F4;
      end;
      E006 := E006 - 1;
   ...
   begin
      ...
      E006 := E006 + 1;
      plane_doors'elab_spec;
      E130 := E130 + 1;
      plane_engines'elab_spec;
      E140 := E140 + 1;
      warning_lights'elab_spec;
      warning_lights'elab_body;
      E144 := E144 + 1;
      plane'elab_spec;
      plane'elab_body;
      E115 := E115 + 1;
...
--  BEGIN Object file/option list
   --   D:\Misc\Napier\Formal Approaches to Software Engineering\ADA\Coursework\obj\plane_doors.o
   --   D:\Misc\Napier\Formal Approaches to Software Engineering\ADA\Coursework\obj\plane_engines.o
   --   D:\Misc\Napier\Formal Approaches to Software Engineering\ADA\Coursework\obj\warning_lights.o
   --   D:\Misc\Napier\Formal Approaches to Software Engineering\ADA\Coursework\obj\plane.o
   --   D:\Misc\Napier\Formal Approaches to Software Engineering\ADA\Coursework\obj\main.o
   --   -LD:\Misc\Napier\Formal Approaches to Software Engineering\ADA\Coursework\obj\
   --   -LD:\Misc\Napier\Formal Approaches to Software Engineering\ADA\Coursework\obj\
   --   -LD:/programs/gnat/lib/gcc/x86_64-pc-mingw32/9.3.1/adalib/
   --   -static
   --   -lgnat
   --   -Wl,--stack=0x2000000
